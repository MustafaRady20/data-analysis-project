...
# Useing Webscraping to Extract Tesla Revenue Data
...
for row in soup.find_all("table", class_="historical_data_table table")[1].find("tbody").find_all("tr"):
    col = row.find_all("td")
    date = col[0].text
    revenue = col[1].text
...
for row in soup1.find_all("table", class_="historical_data_table table")[1].find("tbody").find_all("tr"):
...
# ploting tesla revenue
make_graph(tesla_data, tesla_revenue, "Tesla")

# ploting gmestop revenue
